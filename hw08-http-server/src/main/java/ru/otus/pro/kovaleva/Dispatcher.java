...
import ru.otus.pro.kovaleva.application.processors.CalculatorRequestProcessor;
import ru.otus.pro.kovaleva.application.processors.CreateNewProductProcessor;
import ru.otus.pro.kovaleva.application.processors.GetAllProductsProcessor;
import ru.otus.pro.kovaleva.application.processors.HelloWorldRequestProcessor;
import ru.otus.pro.kovaleva.processors.DefaultOptionsProcessor;
import ru.otus.pro.kovaleva.processors.DefaultStaticResourcesProcessor;
import ru.otus.pro.kovaleva.processors.DefaultUnknownOperationProcessor;
